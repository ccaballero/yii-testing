...
//            ))
	...
	public function actionCreate()
	{
		...
		{
                        $_POST['Postulante']['nombreautor'] = implode(';', $_POST['nombres']);
                        $_POST['Postulante']['apellidoautor'] = implode(';', $_POST['apellidos']);
			$model->attributes=$_POST['Postulante'];
                        $model->id_are = $_POST['Postulante']['id_are'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idpostulante));
		}
