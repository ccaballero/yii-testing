...
<h1>CODIGO UNICO DE OLIMPISTA <?php echo $model->idpostulante; ?></h1>
...
<div id="enlace"><p><a href="/videoteca/index.php?r=postulante/pdf&id=<?php echo $model->idpostulante; ?>">Generar Plantilla PDF</a></p></div>',